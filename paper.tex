...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{figures/fig_effective_gravities.png}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/fig_modulation_contributors.png}
\caption{
...
\backsection[Funding]{
  ...
  grant AGS-1745384, Transatlantic Research Partnership, and the Office of Naval
  Research Coastal Land Air-Sea Interaction DRI.
}
