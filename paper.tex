...
steady solutions for the change of short-wave wavenumber, action, and
...
The restriction on $\varepsilon_L$ becomes readily apparent when we recognize
...
As the numerical solutions are for nonlinear wave action and crest conservation
...
($S_{k,N,g} > 0.9$) stationarity as in subsection \ref{sec:wave_action_conservation},
...
This introduces a additional errors at $\mathcal{O}(\varepsilon_L^2)$.
