...
\begin{enumerate}
  \item Medium stationarity and homogeneity: $k_L \ll k$, $\sigma_L \ll \sigma$
  \item Wavetrain stationarity and homogeneity:
  $\frac{\partial k}{\partial x} \ll k^2$,
  $\frac{\partial k}{\partial t} \ll \sigma k$,
  $\frac{\partial g}{\partial x} \ll gk$,
  $\frac{\partial g}{\partial t} \ll g \sigma$,
\end{enumerate}
