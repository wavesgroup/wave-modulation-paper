...
Working through the theory of \citeA{longuet1960changes,longuet1987propagation}
and the numerical simulation of \citeA{peureux2021unsteady}, I found several
...
\widetilde{a}(\psi) = a \sqrt{
  ...
  \dfrac{\widetilde{N}}{N}}
=
  \left( \dfrac{\widetilde{g}}{g} \right)^{0.75}
  \left( \dfrac{\widetilde{k}}{k} \right)^{0.25}
  \left( \dfrac{\widetilde{N}}{N} \right)^{0.5}
\end{equation}
To the 1$^{st}$ order in $\varepsilon_L$, the amplitude modulation is then:
