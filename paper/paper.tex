...
The long-waves are initialized from rest ($a_L = 0$) and gradually ramped up
...
waves (as opposed to their wavenumber), and is centered on the short-wave group
...
organize into groups due to dispersion.
To test whether the sudden onset of long-wave forcing causes the unstable growth,
...
\citet{peureux2021unsteady} correctly pointed out that the unstable
...
of their dispersion properties or the wind input
(\textit{i.e.} via the short-wave phase speed).
...
acceleration of complex functions, and phase-resolved modeling of short waves,
