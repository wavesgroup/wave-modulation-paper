...
of \citeA{longuet1960changes}, and are similar to the nonlinear numerical
solutions by \citeA{zhang1990evolution}.
We also discuss the result of \citeA{peureux2021unsteady} who found through
...
\citeA{longuet1987propagation} revisited this problem by considering variation
...
\citeA{zhang1990evolution} evaluated the effects of nonlinearity of short waves
...
equations than that of \citeA{longuet1960changes}.
...
\caption{
  ...
  analytical solutions by \citeA{longuet1960changes} (L-HS 1960, black)
  and this paper (blue).
...
A long wave modulates gravitational acceleration at its surface:

\begin{equation}
\label{eq:gravity_modulation_general}
\widetilde{g}(\psi)
  = g \cos{\alpha} 
  + \dfrac{\partial W}{\partial t} \cos{\alpha}
  + \frac{\partial U}{\partial t} \sin{\alpha}
\end{equation}
where $\alpha = \arctan{\frac{\partial \eta}{\partial x}}$ is the local slope
of the long-wave surface.
Curvilinear effects on effective gravity can be removed by setting $\alpha = 0$.
