...
\caption{
  Summary of prior \cite{longuet1960changes,longuet1987propagation,zhang1990evolution} and present (this paper)
  approaches to calculating the modulation of short waves by long waves.
}
...
\caption{Same a Fig. \ref{fig:analytical_solutions_ak0.1} but for $\varepsilon_L = 0.2$.}
\end{figure}
...
\caption{Same a Fig. \ref{fig:analytical_solutions_ak0.1} but for $\varepsilon_L = 0.4$.}
\end{figure}
